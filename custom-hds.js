...
var servePresence = require("./modules/misc/servePresence.js");
...
function initializeModules() {
  ...
  servePresence = new servePresence();
  ...
  if (validModules.location) {
    ...
    location = new location(
      cfg.location.credentials.GEOAPIFY_API_KEY,
      presence
    );
  }
  if (validModules.netflix) {
    ...
    netflix = new netflix(
      cfg.netflix.cookie,
      cfg.netflix.apilayer_apikey,
      cfg.netflix.updateInterval,
      presence
    );
  }
  ...
  if (validModules.valorant) {
    ...
    valorant = new valorant(
      cfg.valorant.henrikDevAPIKey,
      cfg.valorant.riotPUUID,
      cfg.valorant.riotID,
      cfg.valorant.riotTag,
      cfg.valorant.updateInterval,
      presence,
      config
    );
  }
  ...
  if (validModules.duolingo) {
    ...
    duolingo = new duolingo(
      cfg.duolingo.username,
      cfg.duolingo.cookie,
      cfg.duolingo.updateInterval,
      presence
    );
  }
